...
satisfaction = st.sidebar.number_input("Satisfação do funcionário", value=dataset["satisfaction"].mean())
evaluation = st.sidebar.number_input("Avaliação do funcionário", value=dataset["evaluation"].mean())
averageMonthlyHours = st.sidebar.number_input("Média de horas trabalhadas no mes", value=dataset["averageMonthlyHours"].mean())
